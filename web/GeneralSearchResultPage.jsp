...
<%@page import="org.mypackage.nationalpark.GenSearchRequest"%>
<%@page import="org.mypackage.nationalpark.GeneralSearchResult;"%>
<%@page contentType="text/html" pageEncoding="UTF-8" import ="org.mypackage.nationalpark.GenSearchRequest" language="java"%>
...
<html>
    ...
    <body>
        <!-- Header -->
    <header id="header">
        <a class="logo" href="index.html">National Park Information Kiosk</a>
        <nav>
            <a href="#menu">Menu</a>
        </nav>
    </header>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <select name="designation" id="designation">
                                ...
                                <option value="mamc">Mary McLeod Bethune Council House National Historic Site</option>

...
<%@page contentType="text/html" pageEncoding="UTF-8" import ="com.mycompany.nationalparkserviceinfokiosk.VCenterSearchRequest" language="java"%>
...
<html>
    ...
    <section id="main" class="wrapper">
        <div class="inner">
            ...
            <div class="content">
                <form name="General Search" action="VCenterResultPage.jsp">
